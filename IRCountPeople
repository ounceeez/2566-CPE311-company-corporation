...
void LED_Config(void)
{
	...
	GPIO_InitStruct.Pin = LL_GPIO_PIN_6;  //Configure PB6
	...
	LL_GPIO_Init(GPIOB, &GPIO_InitStruct);  //Write configure to GPIOB register
	
	GPIO_InitStruct.Pin = LL_GPIO_PIN_7;  //Configure PB7
	LL_GPIO_Init(GPIOB, &GPIO_InitStruct);  //Write configure to GPIOB register
}
